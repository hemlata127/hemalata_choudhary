...
Description: This script accepts directory name and email address from the user.
	In the entered directory, it creates the log file which contains information about the currently running processes
	The log file is then sent to the entered email address
