...
Description: 
	The script takes a directory name as command line argument. It also implements the command line options -h for displaying help and -u for displaying script usage. The script crawls through the specified directory and lists all the files and folders recursively.
Modules used: sys, os
