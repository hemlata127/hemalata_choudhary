/*
Display current window size on the window - at the center of the window
*/
#include<Windows.h>
#include<assert.h>
#include<stdio.h>
...
{
    static TCHAR szAppName[] = TEXT("Display Current window size");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch(uMsg)
    {
        ...
        case WM_PAINT:
            ...
            TextOut(hdc, cxScreen/2, cyScreen/2, buffer, BUFFER_SIZE);
            EndPaint(hWnd, &ps);
            break;
