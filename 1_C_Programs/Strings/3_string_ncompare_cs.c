...
bool_t string_ncompare_cs(char* p_str1, char* p_str2, long long int n);
...
void test_string_ncompare_cs()
{
    ...
    flag = string_ncompare_cs(p_str1, p_str2, 5);
    if(flag == TRUE)
    ...
    printf("Compare %d characters\n",15);
    flag = string_ncompare_cs(p_str1, p_str2, 15);
    if(flag == TRUE)
        puts("Strings are equal");
    else if(flag == FALSE)
        puts("Strings are not equal");
    ...
    printf("Compare %d characters\n",22);
    flag = string_ncompare_cs(p_str1, p_str2, 22);
    if(flag == TRUE)
        puts("Strings are equal");
    else if(flag == FALSE)
        puts("Strings are not equal");
